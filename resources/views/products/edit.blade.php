...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4" x-data="{ preview: '{{ $product->image_url }}' }">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="mt-1 text-xs text-gray-500">JPG, PNG, GIF, WEBP. Tối đa 5MB. Để trống nếu không muốn đổi ảnh.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="default_price" value="{{ old('default_price', $product->default_price) }}" min="0"
                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                       placeholder="0">
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="note" rows="3"
                          class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                          placeholder="Ghi chú về sản phẩm...">{{ old('note', $product->note) }}</textarea>
            </div>
