...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
    ...
    <div class="flex items-center gap-2">
        <a href="{{ route('products.export') }}"
           class="inline-flex items-center px-4 py-2 border border-green-600 text-green-600 rounded-lg hover:bg-green-50 transition text-sm">
            <i class="fas fa-file-export mr-2"></i>Xuất Excel
        </a>
        <a href="{{ route('products.import') }}"
           class="inline-flex items-center px-4 py-2 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition text-sm">
            <i class="fas fa-file-import mr-2"></i>Import Excel
        </a>
        <a href="{{ route('products.trashed') }}"
           class="inline-flex items-center px-4 py-2 border border-red-400 text-red-500 rounded-lg hover:bg-red-50 transition text-sm">
...
<div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
    <h4 class="font-semibold text-yellow-800 mb-2">
        <i class="fas fa-exclamation-triangle mr-1"></i>Một số dòng không import được:
    </h4>
