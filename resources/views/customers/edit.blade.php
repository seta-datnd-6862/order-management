...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Sửa khách hàng</h1>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('customers.update', $customer) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="facebook_link" value="{{ old('facebook_link', $customer->facebook_link) }}"
                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="zalo_link" value="{{ old('zalo_link', $customer->zalo_link) }}"
                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
